...
export class IdentityController {
  ...
  @ApiOperation({ summary: 'Provision a new tenant', description: 'Creates DB tenant record and Stripe Connect account. Idempotent — safe to call on every login.' })
  ...
  @ApiOperation({ summary: 'Get Stripe Connect onboarding link', description: 'Returns a time-limited Stripe Express onboarding URL for KYC and bank account setup.' })
