...
export class AutomationController {
  ...
  @ApiOperation({ summary: 'Create an automation rule', description: 'Defines a trigger → action rule for the tenant. The rule fires whenever a matching event is received.' })
  ...
  @ApiOperation({ summary: 'Fire an automation event', description: 'Evaluates all active rules for the tenant against the given event and executes matching actions.' })
  @ApiResponse({ status: 201, description: 'Event processed, matching actions fired' })
  @Post('trigger')
