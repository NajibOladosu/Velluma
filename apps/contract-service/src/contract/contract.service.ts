...
export class ContractService {
    ...
    async generateFromPrompt(data: GenerateContractDto) {
        ...
        // 1. Create the base contract record
        ...
        // 2. Generate initial version (Mocked OpenAI/Gemini call)
    ...
    async signContract(data: SignContractDto) {
        ...
        // 2. Generate Cryptographic Hash of the latest document
        ...
        // 3. Record Signature
        const { error: sigError } = await client.from('contract_signatures').insert([{
        ...
        // 5. Check if all parties signed and finalize
        const { data: isFinalized } = await client.rpc('finalize_contract_if_all_signed', {
